...
public class AtlantisBossIA : MonoBehaviour
{
    ...
    private void Muerte()
    {
        ...
        Invoke("DeadSound", .8f);
        PlayerPrefs.SetInt("PuntosAtlantis", PJCont.Puntuacion);
       /* PlayerPrefs.SetInt("Score", PJCont.Puntuacion);*/
  ...
  //  #region FixedUpdate
     ...
     private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.CompareTag("Bullet"))
        {
            ...
            //+10 punt.
            Debug.Log("Daño realizado: " + vidas);
        }
